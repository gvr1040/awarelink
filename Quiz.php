...
<body>
    ...
    <section>
        <h1>STD/STI Knowledge Quiz</h1>
        <p>Test your knowledge about sexually transmitted infections and diseases with our interactive quiz. Select an answer to reveal the fact.</p>

        <div class="quiz">
            <div class="question">1. Are Sexually transmitted diseases (STDs) and Sexually transmitted infections (STIs) the same thing?</div>
            <div class="options">
        ...
        <div class="quiz">
            <div class="question">2. Who can get an STD?</div>
            <div class="options">
        ...
        <div class="quiz">
            <div class="question">3. All STIs have symptoms?</div>
            <div class="options">
        ...
        <div class="quiz">
            <div class="question">4. Can you get an STI from having oral sex?</div>
            <div class="options">
        ...
        <div class="quiz">
            <div class="question">5. How many sexual partners does it take to get an STI?</div>
            <div class="options">
        ...
        <div style="text-align: center; margin-top: 2rem;">
            <a href="Learn.php"><button>Back to Resources</button></a>
        </div>
    </section>
